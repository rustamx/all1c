...
//КомуникацияСПользователем = Новый Консоль;
//КомуникацияСПользователем.ВывестиСтроку("Подтвердите удаления КЭШа. Y - да");
//Ответ = КомуникацияСПользователем.Прочитать();
//Если Ответ = 89 Тогда
//КомуникацияСПользователем.ВывестиСтроку("Удаляю кэш");
//Иначе
//КомуникацияСПользователем.ВывестиСтроку("Прерывание обработки");
//КонецЕсли
